...
export 'nav/nav.dart';
export '../core/toury_dialogs.dart';
export '../core/toury_location_service.dart';
export '../core/toury_navigation.dart';
export '../core/saudi_city_registry.dart';
export '../core/toury_brand_widgets.dart';
export '../core/toury_db_hero.dart';
export '../core/toury_firestore_cache.dart';
export '../core/toury_image.dart';
export '../core/toury_async_guard.dart';
export '../core/toury_mkan_pagination.dart';
export '../core/app_ux_widgets.dart';
...
Future<LatLng?> queryCurrentUserLocation({bool highAccuracy = true}) async {
...
Future<void> setAppLanguage(BuildContext context, String language) async {
  final locale = createLocale(language);
  await context.setLocale(locale);
  await FFLocalizations.storeLocale(language);
  MyApp.of(context).setLocale(language);

  // Refresh geo display labels to match the new UI language (refs stay stable).
  try {
    await TouryLocationService.refreshStoredGeoLabels();
  } catch (error) {
    debugPrint('Could not refresh geo labels: $error');
  }
  ...
  if (user != null) {
    try {
      ...
      debugPrint('Could not save preferred locale: $error');
    }
  }
}
