...
abstract final class FinancialAccountingLoader {
  ...
  static Map<String, FinancialCurrencyTotals> _parseRemoteTotals(
    ...
    raw.forEach((key, value) {
      ...
      t.completedAndCollectedMinor = m('completedAndCollectedMinor');
      t.completedButNotCollectedMinor = m('completedButNotCollectedMinor');
      t.cancelledOrExpiredMinor = m('cancelledOrExpiredMinor');
      t.incompleteMinor = m('incompleteMinor');
      t.expectedPlatformAfterCollection = m('completedPendingPlatformMinor');
      t.expectedDriverNetAfterCollection = m('completedPendingDriverNetMinor');
      t.cashCompletedPending = i('cashCompletedPending');
      t.onlineCompletedPending = i('onlineCompletedPending');
      t.cashCompletedPendingMinor = m('cashCompletedPendingMinor');
      t.onlineCompletedPendingMinor = m('onlineCompletedPendingMinor');
      t.lifecycleCompleted = i('lifecycleCompleted');
      t.lifecycleCancelled = i('lifecycleCancelled');
      t.lifecycleExpired = i('lifecycleExpired');
      out[code] = t;
    });
    return out;
  }
