...
import 'list_vwork_model.dart';
export 'list_vwork_model.dart';

class ListVworkWidget extends StatefulWidget {
  const ListVworkWidget({super.key});

  @override
  State<ListVworkWidget> createState() => _ListVworkWidgetState();
}

class _ListVworkWidgetState extends State<ListVworkWidget> {
  late ListVworkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListVworkModel());
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, listViewIndex) {
            ...
            return InkWell(
              ...
              onTap: () async {
                FFAppState().workcite = listViewVillagesRecord.reference;
                FFAppState().workciteText = listViewVillagesRecord.naim;
                safeSetState(() {});
