...
T? castToType<T>(dynamic value) {
  ...
  switch (T) {
    ...
    case int:
      // Ints may be stored as doubles in Firestore (e.g. 67.5 money fields).
      // Coerce rather than throwing — fractional values round to nearest int.
      if (value is num) {
...
bool showAdminInlineSidebar(BuildContext context) =>
