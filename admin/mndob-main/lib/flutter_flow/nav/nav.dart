...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      // Always AuthGate — never bypass with raw Login1 (skips onboarding /
      // anonymous cleanup / lifecycle routing).
      errorBuilder: (context, state) => const DriverAuthGate(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const DriverAuthGate(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: DriverPendingApprovalWidget.routePath,
          requireAuth: true,
          builder: (context, params) => const DriverPendingApprovalWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: TfaselOrserWidget.routePath,
          requireAuth: true,
          builder: (context, params) => TfaselOrserWidget(
            id: params.getParam(
              'id',
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatWidget(
            ...
            phoneClent: params.getParam(
              'phoneClent',
              ParamType.int,
            ),
            iduserclent: params.getParam(
              'iduserclent',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: DriverWalletWidget.routePath,
          requireAuth: true,
          builder: (context, params) => const DriverWalletWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: Ttb3Widget.routePath,
          builder: (context, params) => Ttb3Widget(
            ido: params.getParam(
              'ido',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: CanselWidget.routeName,
          path: CanselWidget.routePath,
          requireAuth: true,
          builder: (context, params) => params.isEmpty
